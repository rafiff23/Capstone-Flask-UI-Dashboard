...
def index():
    ...
    stats = {
        ...
        agg({'Reviews' : 'sum', 'Rating' : 'mean'}).sort_values(by = 'Reviews', ascending =False)\
        .reset_index().head(11).shift()[1:].to_html(classes=['table thead-light table-striped table-bordered table-hover table-sm'])
    }
